...
import { ArrowLeft, BarChart2, Heart, Plus, PowerIcon as Pulse, Trash2, Zap } from "lucide-react"
                    ...
                    {devices.length > 0 ? (
                          ...
                          <div className="flex p-4">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center">
                                  <span className={`mr-2 h-2 w-2 rounded-full ${device.connected ? 'bg-green-500' : 'bg-gray-300'}`}></span>
                      ...
                      <div className="flex flex-col items-center justify-center py-12 text-center">
                        ...
                        <p className="text-muted-foreground">
                          Connect your first health device to start tracking your health data
                        </p>
                      </div>
                    )}
                  </div>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card>
                      ...
                      <CardContent className="h-[200px] flex items-center justify-center">
                        <div className="w-full h-full bg-muted rounded-md flex items-center justify-center">
                          <p className="text-muted-foreground">Heart rate chart visualization</p>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card>
                      ...
                      <CardContent className="h-[200px] flex items-center justify-center">
                        <div className="w-full h-full bg-muted rounded-md flex items-center justify-center">
                          <p className="text-muted-foreground">Steps chart visualization</p>
                        </div>
                      </CardContent>
                    </Card>
                  ...
                  <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-950 rounded-md">
                    <p className="text-sm text-blue-800 dark:text-blue-300">
                      This data is collected from your connected devices and is for informational purposes only.

...
import { ArrowLeft, Calendar, Download, FileText, Share2, Zap } from "lucide-react"
          ...
          <Card className="mb-8">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>View and manage your medical history securely</CardDescription>
                </div>
            ...
            <CardContent>
              <Tabs defaultValue="summary" onValueChange={setActiveTab} className="w-full">
                        ...
                        <ul className="space-y-2">
                          <li className="flex items-start gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">Diagnosed on May 15, 2023</p>
                            </div>
                          </li>
                          <li className="flex items-start gap-2">
                            <FileText className="h-5 w-5 text-primary mt-0.5" />
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">Diagnosed on March 3, 2023</p>
                            </div>
                          </li>
                        </ul>
                      </CardContent>
                        ...
                        <ul className="space-y-2">
                          <li className="flex items-start gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">Once daily for allergies</p>
                            </div>
                          </li>
                          <li className="flex items-start gap-2">
                            <FileText className="h-5 w-5 text-primary mt-0.5" />
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">Once daily supplement</p>
                            </div>
                          </li>
                        </ul>
                      </CardContent>
                        ...
                        <ul className="space-y-2">
                          <li className="flex items-start gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">July 12, 2023 at 10:00 AM</p>
                            </div>
                          </li>
                          <li className="flex items-start gap-2">
                            <Calendar className="h-5 w-5 text-primary mt-0.5" />
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">August 3, 2023 at 2:30 PM</p>
                            </div>
                          </li>
                        </ul>
                      </CardContent>
                ...
                <TabsContent value="diagnoses" className="pt-6">
                  <Table>
                    <TableHeader>
                      <TableRow>
                    ...
                    <TableBody>
                      <TableRow>
                        <TableCell className="font-medium">Seasonal Allergies</TableCell>
                      ...
                      <TableRow>
                        <TableCell className="font-medium">Tension Headache</TableCell>
                      ...
                      <TableRow>
                        <TableCell className="font-medium">Common Cold</TableCell>
                ...
                <TabsContent value="medications" className="pt-6">
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        <TableCell className="font-medium">Loratadine</TableCell>
                ...
                <TabsContent value="visits" className="pt-6">
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        <TableCell className="font-medium">May 15, 2023</TableCell>
                        <TableCell>Dr. Sarah Johnson</TableCell>
                      ...
                      <TableRow>
                        <TableCell className="font-medium">March 3, 2023</TableCell>
                        <TableCell>Dr. Michael Chen</TableCell>
                      ...
                      <TableRow>
                        <TableCell className="font-medium">January 10, 2023</TableCell>
                        <TableCell>Dr. Sarah Johnson</TableCell>
                        <TableCell>Primary Care</TableCell>
